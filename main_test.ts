...
const testCases: {data: Data, expect: boolean, description: string}[] = [
    ...
    },
    {
        ...
        expect: true,
        description: "Two different teams each with one entry and one exit in correct order"
    },
    {
        data: [
            {
        ...
        expect: true,
        description: "Entries and exits for different teams out of order but correct based on time"
    },
    {
        data: [
            {
    ...
    },
    {
        ...
        expect: false,
        description: "One team has an entry with no exit while another team is correct"
    },
    {
        data: [
            {
        ...
        expect: true,
        description: "Multiple entries and exits for the same team in correct order"
    },
    {
        data: [
            {
    ...
    },
    {
        ...
        expect: false,
        description: "A team entry after the exit of another team which was entered twice"
    },
]
